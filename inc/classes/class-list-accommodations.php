...
class List_Accommodations {
    ...
    public function setup_hooks() {
        ...
        add_action( 'wp_ajax_search_accommodations', [ $this, 'search_accommodations_callback' ] );
        add_action( 'wp_ajax_nopriv_search_accommodations', [ $this, 'search_accommodations_callback' ] );
    ...
    public function search_accommodations_callback() {
        if ( isset( $_POST['search'] ) ) {
            $search = sanitize_text_field( $_POST['search'] );
            echo $this->get_searched_accommodations( $search );
        } else {
            echo $this->get_searched_accommodations( '' );
        }
        wp_die();
    }

    public function get_searched_accommodations( $search ) {
